  ...
  <div class="content" id="multi-fotos">
    <div class="wrapper">
      <h2 class="titulo" style="
        ...
        @endisset
      ">{{ $products->title->text ?? 'Produtos Personalizados' }}</h2>
    </div>
    ...
    <div class="overflow">
      <div class="container-multi_photos wrapper" id="produtos">
        @foreach($products->items as $prod_item)
          ...
          <div
            class="multi_photo col-xl-4 col-lg-4 col-md-4 col-sm-6 mb-3 product-item {{
